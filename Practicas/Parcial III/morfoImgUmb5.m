...
L = bwlabel(BW,4);
    ...
    figure; subplot(1,2,1); imshow(Img): title('Region');
    ...
    subplot(2,3,2); imshow(,[]); title("")
    subplot(2,3,3); imshow(,[]); title("")
    subplot(2,3,4); imshow(,[]); title("")
    subplot(2,3,5); imshow(,[]); title("")
    subplot(2,3,6); imshow(,[]); title("")